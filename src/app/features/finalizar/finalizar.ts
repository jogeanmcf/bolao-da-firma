...
@Component({
  ...
  imports: [],
  template: `
    <div class="min-h-screen bg-linear-to-b from-lotofacil-700 to-lotofacil-800 p-6 flex items-center">
      <div class="p-8 flex flex-col gap-4 max-w-3xl w-full mx-auto bg-white rounded-2xl shadow-xl ring-1 ring-black/5 overflow-hidden">
        <h1 class="text-2xl font-bold text-lotofacil-700">É hora do PIX</h1>
        <p class="text-gray-600">Agora é só fazer o PIX e contar com a sorte! 🍀</p>
        <p class="text-md text-gray-500 mt-2 text-center">Valor: <span class="font-medium text-gray-700">R$ 28</span></p>
        <div class="flex flex-col gap-6 justify-around items-center md:flex-row">
          <div class="flex flex-col items-center md:items-start gap-4">
            ...
            <div class="mt-2 flex gap-3">
              <button
                ...
                (click)="copyCode()"
                aria-live="polite"
                class="inline-flex items-center gap-2 bg-lotofacil-600 hover:bg-lotofacil-700 text-white font-medium px-4 py-2 rounded-lg shadow transition"
              >
              @if(copied){
          ...
          <div class="flex flex-col items-center gap-4">
            ...
            <img src="assets/qr-code-independencia.jpeg" alt="QR code" class="w-56 h-56 rounded-lg shadow-md object-cover"/>
          </div>
        </div>
      </div>
    </div>
