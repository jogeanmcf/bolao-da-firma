          ...
          <form class="space-y-6" (ngSubmit)="onSubmit()">
            ...
            <div class="space-y-2">
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 text-gray-700 placeholder-gray-400 focus:border-purple-600 focus:outline-none transition-colors"
              />
            </div>
            <button
              [disabled]="this.username == null || this.username == ''"
              [class.opacity-70]="this.username== ''"
              class="inline-flex items-center justify-center w-full bg-purple-600 text-white font-bold py-3 rounded-xl hover:bg-purple-700 transition-colors shadow-lg"
              (click)="goToRules()"
            >
